...
public class NlpirTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            // TODO: 2016/11/22
            File []files = TFIDF.getAllFile("D:\\实例\\实例数据");
...
//				System.out.println(cutList.size());
                // TODO: 2016/11/22
                String file = "d:\\实例\\test\\"+f.getName().substring(0,f.getName().lastIndexOf("."))+".txt";
            ...
            // TODO: 2016/11/22
            File newFile = new File("d:\\实例\\map.txt");
            FileOutputStream foutput = null;
            foutput = new FileOutputStream(newFile);
            int count = 0;
            int countMap = 0;
            ...
            for(Object key :dir.keySet() )
            {
                if(!stopList.contains(key)) {
                    //if(dir.get(key)>200&&key.toString().length()>1) {
                        String str = key + "\r\n";
